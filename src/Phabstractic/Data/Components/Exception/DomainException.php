 ...
 * 
 */
namespace Phabstractic\Data\Components\Exception
{
    require_once(realpath( __DIR__ . '/../../../') . '/falcraftLoad.php');
    
    $includes = array('/Data/Components/Exception/ExceptionInterface.php',);
    
    falcraftLoad($includes, __FILE__);
    
    /**
     * A local domain exception for class dependency in data components
     * 
     * CHANGELOG
     * 
